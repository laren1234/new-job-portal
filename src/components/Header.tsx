...
import { Briefcase, Users, FileText, Settings, Bell, Plus, Menu } from 'lucide-react';
    ...
    <header className="bg-white/95 backdrop-blur-md shadow-lg border-b border-white/20 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-3">
            <button className="p-3 text-slate-400 hover:text-slate-600 hover:bg-slate-50 rounded-2xl transition-all duration-300">
            ...
            <button className="md:hidden p-3 text-slate-400 hover:text-slate-600 hover:bg-slate-50 rounded-2xl transition-all duration-300">
